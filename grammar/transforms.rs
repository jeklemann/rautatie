...
pub fn get_infinitive(verb: &Verb) -> TransformLogEntry {
...
pub fn get_strong_stem(verb: &Verb) -> TransformLogEntry {
    return TransformLogEntry {
...
pub fn get_weak_stem(verb: &Verb) -> TransformLogEntry {
    return TransformLogEntry {
...
fn add_personal_ending(verb: &Verb, person: Person) -> TransformLogEntry {
...
pub fn add_first_person_singular_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::FirstSingular);
}

pub fn add_second_person_singular_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::SecondSingular);
}

pub fn add_third_person_singular_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::ThirdSingular);
}

pub fn add_first_person_plural_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::FirstPlural);
}

pub fn add_second_person_plural_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::SecondPlural);
}

pub fn add_third_person_plural_ending(verb: &Verb) -> TransformLogEntry {
    return add_personal_ending(verb, Person::ThirdPlural);
}

pub fn add_type_one_passive_marker(verb: &Verb) -> TransformLogEntry {
    let harmonized_a = verb.infinitive.chars().last().unwrap();
...
pub fn modify_stem_for_type_one_passive(verb: &Verb) -> TransformLogEntry {
...
pub fn add_present_passive_ending(verb: &Verb) -> TransformLogEntry {
    let harmonized_a = verb.infinitive.chars().last().unwrap();
...
fn prepend_personal_negative(verb: &Verb, person: Person) -> TransformLogEntry {
...
pub fn prepend_first_person_singular_negative(verb: &Verb) -> TransformLogEntry {
    return prepend_personal_negative(verb, Person::FirstSingular);
}

pub fn prepend_second_person_singular_negative(verb: &Verb) -> TransformLogEntry {
    return prepend_personal_negative(verb, Person::SecondSingular);
}

pub fn prepend_third_person_singular_negative(verb: &Verb) -> TransformLogEntry {
    return prepend_personal_negative(verb, Person::ThirdSingular);
}

pub fn prepend_first_person_plural_negative(verb: &Verb) -> TransformLogEntry {
    return prepend_personal_negative(verb, Person::FirstPlural);
}

pub fn prepend_second_person_plural_negative(verb: &Verb) -> TransformLogEntry {
    return prepend_personal_negative(verb, Person::SecondPlural);
}

pub fn prepend_third_person_plural_negative(verb: &Verb) -> TransformLogEntry {
